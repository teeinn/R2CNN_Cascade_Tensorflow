...
MOMENTUM = 0.9
LR = 0.0003  # 0.0003
# DECAY_STEP = [60000, 120000]
# DECAY_STEP = [60000, 180000, 450000, 940000]  # 90000, 120000
DECAY_STEP = [60000, 180000]
# DECAY_STEP = [60000, 250000, 450000]# 90000, 120000
...
USE_DROPOUT = False
KEEP_PROB = 1.0
SHOW_SCORE_THRSHOLD = 0.01 #0.5  # only show in tensorboard

FAST_RCNN_NMS_IOU_THRESHOLD = 0.1   # 0.6
FAST_RCNN_NMS_MAX_BOXES_PER_CLASS = 150
FAST_RCNN_IOU_POSITIVE_THRESHOLD = [0.3, 0.4, 0.5]
