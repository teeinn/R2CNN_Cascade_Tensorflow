...
if __name__ == "__main__":
    ...
    src_dir = '/media/qisens/2tb1/goodroof_solarpanel_parkinglot_rooftop_facility_rotation/area2_400images/no_heliport_rebuilt/'
    separated_dir = '/media/qisens/2tb1/goodroof_solarpanel_parkinglot_rooftop_facility_rotation/area2_400images/resize_small'
