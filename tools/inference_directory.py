...
if __name__ == '__main__':
    images_dir = '/media/qisens/2tb1/python_projects/inference_pr/aws_ec2_inference_server_seg_slide/tmp/new_poc_area_Input/seochogu_office_blur'
    output_dir = '/media/qisens/2tb1/python_projects/training_pr/R2CNN_Cascade_Tensorflow/inference_results'

    if not os.path.exists(output_dir):
        os.mkdir(output_dir)

    model_path = "/media/qisens/2tb1/python_projects/training_pr/R2CNN_Cascade_Tensorflow/output/trained_weights/FasterRCNN_20180515_DOTA_v3/voc_228001model.ckpt"
    infer_time_total = 0
    file_cnt = 0
